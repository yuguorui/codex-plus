...
fn anthropic_thinking_from_reasoning(reasoning: Option<&Reasoning>) -> Option<AnthropicThinking> {
    ...
    match effort {
        ...
        | ReasoningEffort::Persistent => Some(AnthropicThinking::Enabled {
    ...
    for item in content {
        match item {
            ...
            ContentItem::InputImage { image, detail } => {
                ...
                // The Anthropic Messages API only accepts inline image sources.
        ...
        FunctionCallOutputBody::ContentItems(items) => Value::Array(
            items
                ...
                .filter_map(|item| match item {
                    ...
                    FunctionCallOutputContentItem::InputImage { image, detail: _ } => match image {
